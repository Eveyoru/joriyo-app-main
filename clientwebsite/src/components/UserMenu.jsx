        ...
        <div className='text-sm grid gap-1'>
            {
              isAdmin(user.role) && (
                <>
                  ...
                  <Link onClick={handleClose} to={"/dashboard/banners"} className='px-2 hover:bg-orange-200 py-1'>Banners</Link>
                  <Link onClick={handleClose} to={"/dashboard/featured-categories"} className='px-2 hover:bg-orange-200 py-1'>Featured Categories</Link>
                  <Link onClick={handleClose} to={"/dashboard/vendors"} className='px-2 hover:bg-orange-200 py-1'>Vendors</Link>
                  <Link onClick={handleClose} to={"/dashboard/allorders"} className='px-2 hover:bg-orange-200 py-1'>All Orders</Link>
                  <Link onClick={handleClose} to={"/dashboard/customers"} className='px-2 hover:bg-orange-200 py-1'>Customers</Link>
                </>
              )
            }
